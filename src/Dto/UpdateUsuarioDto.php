...
final class UpdateUsuarioDto
{
    #[Assert\NotBlank(allowNull: true, message: 'Ingrese el nombre de usuario.')]
    #[Assert\Length(max: 180, maxMessage: 'El nombre de usuario no puede superar los {{ limit }} caracteres.')]
    public ?string $username = null;

    #[Assert\NotBlank(allowNull: true, message: 'Ingrese el apellido.')]
    ...
    #[Assert\NotBlank(allowNull: true, message: 'Ingrese el correo electrónico.')]
